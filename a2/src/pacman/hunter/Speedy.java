...
public class Speedy extends Hunter {
    ...
    /**
     * If Speedy's special is active then we move twice instead of once. While
     * moving we still do all the normal steps that Hunter.move(PacmanGame) does.
     ...
     * "x,y,DIRECTION,specialDuration,SPEEDY". DIRECTION is the uppercase enum
     * type value. Example: "4,5,LEFT,12,SPEEDY"
     * @return "x,y,DIRECTION,specialDuration,SPEEDY"
     */
    @Override
    public String toString() {
        return super.toString().concat(",SPEEDY");
    }
}
